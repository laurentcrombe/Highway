...
!function (t, e) {
  "object" == ( false ? "undefined" : _typeof(exports)) && "object" == ( false ? "undefined" : _typeof(module)) ? module.exports = e() :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.Highway = e() : t.Highway = e();
}(undefined, function () {
  return function (t) {
    function e(i) {
    ...
    function i(t, e) {
      ...
      function t(t, e) {
        ...
        o = function () {
      function t(e) {
        i(this, t), this.views = e.views, this.mode = e.mode || "out-in", this.onPopstate = this.popstate.bind(this), this.onPathChange = this.change.bind(this), window.addEventListener("popstate", this.onPopstate), this.bind(), this.init();
      }return r(t, [{ key: "init", value: function value() {
          var t = document.querySelector("title").innerHTML,
              e = document.querySelector("[router-view]"),
              n = e.getAttribute("router-view");this.path = window.location.pathname, this.stack = {}, this.stack[this.path] = { title: t, view: e, name: n }, this.current = new this.views[n](this.stack[this.path]), this.current.init();var i = !0,
              r = !1,
              o = void 0;try {
            for (var a, u = this.links[Symbol.iterator](); !(i = (a = u.next()).done); i = !0) {
              var c = a.value;c.pathname === this.path && this.active(c);
            }
          } catch (t) {
            r = !0, o = t;
          } finally {
          ...
          this.links = document.querySelectorAll("a:not([router-disable])");var t = !0,
              e = !1,
              n = void 0;try {
            for (var i, r = this.links[Symbol.iterator](); !(t = (i = r.next()).done); t = !0) {
              var o = i.value;o.addEventListener("click", this.onPathChange), o.addEventListener("touchstart", this.onPathChange);
            }
          } catch (t) {
            e = !0, n = t;
          } finally {
          ...
          var t = !0,
              ...
              n = void 0;try {
            for (var i, r = this.links[Symbol.iterator](); !(t = (i = r.next()).done); t = !0) {
              var o = i.value;o.removeEventListener("click", this.onPathChange), o.removeEventListener("touchstart", this.onPathChange);
            }
          } catch (t) {
            e = !0, n = t;
          } finally {
        ...
        } }, { key: "popstate", value: function value() {
          this.path = window.location.pathname, this.fetchCall();
        } }, { key: "active", value: function value(t) {
          var e = t.getAttribute("router-active");if (e) {
            if (this.HTMLActive) {
              var n = this.HTMLActive.getAttribute("router-active");this.HTMLActive.classList.remove(n);
            }this.HTMLActive = t, this.HTMLActive.classList.add(e);
          }
        } }, { key: "change", value: function value(t) {
          t = t || window.event, t.preventDefault && t.preventDefault(), t.returnValue = !1;var e = t.currentTarget,
              n = e.getAttribute("href");if ("_blank" === e.getAttribute("target")) return window.open(n, "_blank");this.update(n);
        } }, { key: "update", value: function value(t) {
          t !== this.path && (this.path = t, window.history.pushState({ path: this.path }, "", this.path), this.fetchCall());
        } }, { key: "fetchCall", value: function value() {
          var t = this;if (!this.stack[this.path]) return void fetch(this.path).then(function (t) {
            return t.text();
          }).then(function (e) {
            return t.fetchSuccess(e);
          }).catch(function (e) {
            return t.fetchError(e);
          });this.redirect();
        } }, { key: "fetchSuccess", value: function value(t) {
          var e = document.createRange().createContextualFragment(t),
              n = e.querySelector("title").innerHTML,
              i = e.querySelector("[router-view]"),
              r = i.getAttribute("router-view");this.stack[this.path] = { title: n, view: i, name: r }, this.redirect();
        } }, { key: "fetchError", value: function value(t) {
          throw Error(t);
        } }, { key: "redirect", value: function value() {
          var t = this,
              e = this.stack[this.path].name;switch (this.previous = this.current, this.current = new this.views[e](this.stack[this.path]), this.unbind(), this.mode) {case "both":
              this.current.load(), this.previous.unload().then(this.bind).catch(function (t) {
                throw Error(t);
              });break;case "in-out":
              this.current.load().then(function () {
                return t.previous.unload();
              }).then(function () {
                return t.bind();
              }).catch(function (t) {
                throw Error(t);
    ...
    function i(t, e) {
      ...
      function t(t, e) {
        ...
        o = function () {
      function t(e) {
        i(this, t), this.wrapper = document.querySelector("[router-wrapper]"), this.title = e.title, this.view = e.view;
      }return r(t, [{ key: "init", value: function value() {
          this.onEnterCompleted();
        } }, { key: "append", value: function value() {
          document.title = this.title, this.wrapper.appendChild(this.view);
        } }, { key: "remove", value: function value() {
          this.wrapper.removeChild(this.view);
        } }, { key: "load", value: function value() {
          var t = this;return this.onEnter(), this.append(), new Promise(function (e, n) {
            t.transition.in(t.view, function () {
              e(), t.analytics(), t.onEnterCompleted();
            });
          });
        } }, { key: "unload", value: function value() {
          var t = this;return this.onLeave(), new Promise(function (e, n) {
            t.transition.out(t.view, function () {
              e(), t.remove(), t.onLeaveCompleted();
            });
          });
        } }, { key: "analytics", value: function value() {
          "undefined" != typeof ga && (ga("set", { page: window.location.pathname, title: document.title }), ga("send", "pageview"));
        } }]), t;
    }();e.default = o;
  }, function (t, e, n) {
    "use strict";
    function i(t) {
      return t && t.__esModule ? t : { default: t };
        ...
        a = n(0),
        u = i(a),
        c = { View: o.default, Router: u.default };e.default = c;
  }]);
});
		...
		this.check = function (init) {
			...
			if (missing === 0 && func) {
				...
				if (global) {
					...
					if (!hasModule && "function" === "function" && __webpack_require__(8)) {
						//AMD
